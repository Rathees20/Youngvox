              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 pr-10 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#A82228] focus:border-transparent appearance-none ${formData.gender ? 'text-black' : 'text-gray-400'}`}
                    required
                  >
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 pr-10 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#A82228] focus:border-transparent appearance-none ${formData.occupation ? 'text-black' : 'text-gray-400'}`}
                    required
                  >
