      ...
      <div className="max-w-[1440px] mx-auto px-4 h-full flex items-center">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button className="hidden md:flex bg-[#A82228] text-white px-6 py-2 rounded-lg items-center space-x-2 hover:bg-[#8a1c22] transition-colors">
        ...
        {isMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 border-t border-gray-200">
            <div className="flex flex-col space-y-3 pt-4">
              ...
              <button className="bg-[#A82228] text-white px-6 py-2 rounded-lg flex items-center justify-center space-x-2 hover:bg-[#8a1c22] transition-colors mt-2">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd" />
                </svg>
                <span>Donate now</span>
