        ...
        <div className="flex items-center justify-between w-full">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link
              ...
              className={`text-[#364153] hover:text-[#A82228] transition-colors scroll-smooth inline-block text-lg ${clickedItem === 'chapters' ? 'animate-bounce-click' : ''}`}
            >
              Chapters
            </Link>
            <Link
            ...
            <div className="flex flex-col h-full pt-20 px-6">
              <div className="flex flex-col space-y-4">
                ...
                <Link
                  ...
                  className={`text-[#364153] hover:text-[#A82228] transition-colors py-2 scroll-smooth inline-block text-lg ${clickedItem === 'chapters-mobile' ? 'animate-bounce-click' : ''}`}
                >
                  Chapters
                </Link>
                <Link
