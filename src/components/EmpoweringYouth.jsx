      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
            ...
            <button className="bg-[#A82228] text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-[#8a1c22] transition-colors w-full sm:w-auto">
              Join YoungVox
            </button>
          </div>
          ...
          <div className="relative order-1 lg:order-2">
            ...
            <button
              onClick={prevSlide}
              className="absolute -left-4 sm:-left-5 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center hover:shadow-xl transition-all z-10 shadow-lg border border-gray-200"
            ...
            <button
              onClick={nextSlide}
              className="absolute -right-4 sm:-right-5 top-1/2 -translate-y-1/2 w-10 h-10 sm:w-12 sm:h-12 bg-white rounded-full flex items-center justify-center hover:shadow-xl transition-all z-10 shadow-lg border border-gray-200"
