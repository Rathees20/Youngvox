...
const ImpactSnapshot = () => {
    ...
    const impactStats = [
        ...
        {
            id: 4,
            label: "Expanding soon PAN India"
        }
    ];
    ...
    const count4 = useCountUp(impactStats[3].number || 0, 0, 2000, isVisible);
    ...
    return (
        <section ref={ref} className="relative py-8 md:py-10 lg:py-12 overflow-hidden min-h-[400px] md:min-h-0">
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                {/* Section Header */}
                <div className={`text-center mb-4 md:mb-2 ${isVisible ? 'animate-fade-in-down' : 'opacity-0'}`}>
                ...
                <div className="hidden md:flex justify-center items-center my-6">
                    <div className="relative flex items-center ml-20" style={{ width: '850px', height: '240px' }}>
                        {impactStats.map((stat, index) => {
                            // Alternate positions: down, up, down, up
                            const topPosition = index % 2 === 0 ? '30px' : '0px';
